    ...
    <script type="text/javascript">
        ...
        function submitForm() {
            ...
            if (checkData()) {
                ...
                if ($("#alipay").hasClass("img_on")) {

                    $("#rechargeForm").attr("action","${pageContext.request.contextPath}/loan/toRechargeByAlipay");
                } else if ($("#weixinpay").hasClass("img_on")) {
                    $("#rechargeForm").attr("action", "${pageContext.request.contextPath}/loan/toRechargeByWeixinpay");
                }
                $(".input_text").removeClass("input-red");
                $("#div1_1").hide();
                $("#dialog-overlay").show();
