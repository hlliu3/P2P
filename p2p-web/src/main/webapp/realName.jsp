        ...
        <div class="fl">
            ...
            <div class="login-form reg-form">
              ...
              <div class="login-box clearfix " style="z-index:90;">
                <label>身份证号</label>
                <input type="text" id="idCard" name="idCard" class="input_text" maxlength="20"  placeholder="请输入15位或20位身份证号码" autocomplete="off" onblur="checkCardId();"/>
              ...
              <div class="login-box clearfix" style="z-index:80;">
                ...
                <label>确认身份证号</label>
                <input type="text" id="replayIdCard" name="replayIdCard" class="input_text" maxlength="21"  placeholder="请再次输入15位或20位身份证号码" onblur="checkAffirmCardId()"/>
