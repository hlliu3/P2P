        ...
        <div class="fund-guanli clearfix">
            ...
            <div class="right-body">
                ...
                <div class="unrecognized" style = "display:block;" id="unrecognized1">
                    ...
                    <%--<img src="${pageContext.request.contextPath}/path/toRechargeByWeixinpay&d="+new Date().getTime()/>--%>
                    <img src="${pageContext.request.contextPath}/loan/createQRCode?rechargeNo=${rechargeNo}&rechargeMoney=${rechargeMoney}&d="+new Date().getTime()/>
                </div>
