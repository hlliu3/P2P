...
<div class="headBody" id="headBody">
    ...
    <div class="headCnt clearfix">
        ...
        <ul class="main-nav">
            ...
            <li>
            	<h2><a id="wytz" href="${pageContext.request.contextPath}/loan/loan?pageSize=9">我要投资<i></i></a></h2>
            	<div class="menu-drop" style="display:none;">
	               <a href="${pageContext.request.contextPath}/loan/loan?ptype=1&pageSize=9">优选类产品</a>
	               <a href="${pageContext.request.contextPath}/loan/loan?ptype=2&pageSize=9">散标类产品</a>
	            </div>
            </li>
                    ...
                    <div class="logged">
                        <div class="userinfo-up">
                            <a href="loan/myCenter" class="user-phone">${user.phone}</a><a
                                href="/webPage/account/member_systems.html" class="user-vip" id="member">VIP1</a><i></i>
                        </div>
                        <div class="userinfo-drop-down" style="height: 0px;">
                            <div class="down-bk">
                                ...
                                <ul class="quick-entry clearfix">
                                    ...
                                    <li class="icon-invest" style="margin-left:85px;"><a href="${pageContext.request.contextPath}/loan/loan?pageSize=9"><i></i><span>投资</span></a>
                                    </li>
                                </ul>
                                <div class="enter">进入“<a href="${pageContext.request.contextPath}/loan/myCenter">我的小金库</a>”
                                </div>
