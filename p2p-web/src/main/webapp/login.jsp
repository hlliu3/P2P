            ...
            <div class="login-cnt clearfix">
                <div class="login-form">
                    ...
                    <div class="login-box clearfix" style="z-index:8; padding-bottom:0px;">
                        ...
                        <input id="loginPassword" name="loginPassword" type="password" placeholder="请输入登录密码"
                               class="input_text" maxlength="16" onblur="checkPassWord()"/>
                    </div>
                    <div class="login-yzm">
                    ...
                    <div class="bn-login" id="loginId">
                        <button onclick="userLogin()">登&nbsp;&nbsp;录</button>
                    </div>
                </div>
                ...
                <div class="login-right">
                    ...
                    <div class="top-txt">
                        动力金融网，便捷的投资平台
                        <br/><br/>
                        加入动力金融网<br/>坐享<span id="historyAverageRate"></span>%历史年化收益
                    </div>
